...
const ROOMS = [
  ...
  { id: 2, hotel: 'The Grand Meridian', name: 'Presidential Suite', type: 'Suite', capacity: 4, price: 980, status: 'occupied' },
  ...
  { id: 5, hotel: 'Alpine Chalet Zermatt', name: 'Mountain Suite', type: 'Suite', capacity: 3, price: 620, status: 'available' },
]
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1 style={{ fontSize: '1.6rem', fontWeight: 700, marginBottom: 4 }}>Rooms</h1>
          <p style={{ fontSize: '0.875rem', color: 'var(--gray-400)' }}>{rooms.length} total rooms</p>
        </div>
      ...
      <div className="table-card">
        <table className="data-table">
          <thead>
            <tr>
              <th>Room</th><th>Hotel</th><th>Type</th><th>Capacity</th><th>Price/Night</th><th>Status</th><th>Actions</th>
            </tr>
          </thead>
          <tbody>
            {rooms.map(r => (
