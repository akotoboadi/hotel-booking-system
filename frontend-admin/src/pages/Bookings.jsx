...
const BOOKINGS = [
  ...
  { id: 'BK004', guest: 'David Osei', hotel: 'Alpine Chalet Zermatt', room: 'Mountain Suite', checkIn: '2025-08-15', checkOut: '2025-08-20', amount: 3100, status: 'cancelled' },
    ...
    <div className="bookings-page">
      ...
      <div className="page-controls">
        <div className="search-input">
          <Search size={15} />
          <input placeholder="Search by guest, hotel, or ID..." value={search} onChange={e => setSearch(e.target.value)} />
        </div>
        <div className="status-tabs">
          {['all', 'confirmed', 'pending', 'cancelled'].map(s => (
            <button key={s} className={`status-tab ${statusFilter === s ? 'status-tab--active' : ''}`} onClick={() => setStatusFilter(s)}>
