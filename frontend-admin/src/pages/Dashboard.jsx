...
const RECENT_BOOKINGS = [
  ...
  { id: 'BK004', guest: 'David Osei', hotel: 'Alpine Chalet Zermatt', checkIn: '2025-08-15', nights: 5, amount: 3100, status: 'cancelled' },
]
    ...
    <div className="dashboard">
      ...
      <div className="dashboard__charts">
        <div className="chart-card">
          <div className="chart-card__header">
            ...
            <span className="chart-card__period">Last 8 months</span>
          </div>
      ...
      <div className="dashboard__table-card">
        <div className="chart-card__header">
          ...
          <a href="/bookings" className="btn-primary">View All</a>
        </div>
